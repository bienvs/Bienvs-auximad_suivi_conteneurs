...
class ReceptionView(QWidget):
    ...
    ## -------------------------------------------------------------------TRANSPORTEUR-----------------------------------------------------------------------
        ...
        self.edit_etat_tc.setReadOnly(True)
        self.cb2 = QComboBox()
        ...
        self.edit_date_envoi.setReadOnly(True)
        self.label_lieu_envoi = QLabel("à:")
        self.edit_lieu_envoi = QLineEdit()
        self.edit_lieu_envoi.setReadOnly(True)
